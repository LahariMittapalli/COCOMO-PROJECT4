...
public class COCOMOIntermediateTest {
	...
	static void calculate(float table2[][], int n, String[] mode, float size) {
		...
		double EAF = 1;
		float table[][] = { { 3.2f, 1.05f, 2.5f, 0.38f }, { 3.0f, 1.12f, 2.5f, 0.35f }, { 2.8f, 1.20f, 2.5f, 0.32f } };
